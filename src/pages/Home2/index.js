...
import { ServiveBoxMain, ImgBox, Heading, Paragraph, Paragraph1, BlogBoxMain, ImgBoxBlog, HeadingBlog, ParagraphBlog, ButtonABC } from './Home2Styled'
                    ...
                    <div ref={menuRef} className={`pt-[17px] absolute max-lg:left-0 max-lg:w-full max-lg:bg-gray-100 max-lg:shadow-lg max-lg:transition-all max-lg:duration-300 ${menuOpen ? 'top-[0px]' : '-top-[600px]'} lg:static`}>
                        <ul onClick={() => setMenuOpen(false)} className='flex gap-[45px] max-lg:flex-col max-lg:w-[100%] max-xl:gap-[30px]'>
                            ...
                            <li className='max-lg:w-[100%] max-lg:text-center  group relative flex justify-center max-lg:max-h-[300px] max-lg:border-b max-lg:border-gray-300 max-lg:pb-2'>
                                <button onClick={toggleMenu} className='no-underline text-base font-medium leading-[24px] tracking-[1.6px] text-[#fff] whitespace-nowrap cursor-pointer'>
                                    Home +
                                </button>
                            ...
                            <li className="max-lg:w-[100%] max-lg:text-center max-lg:border-b max-lg:border-gray-300 max-lg:pb-2">
                                <Link to='/about' className='max-lg:my-1 max-lg:mx-2 no-underline text-base font-medium leading-[24px] tracking-[1.6px] text-[#fff] -ml-[6px]'>About</Link>
                            </li>
                            <li className="max-lg:w-[100%] max-lg:text-center max-lg:border-b max-lg:border-gray-300 max-lg:pb-2">
                                <Link to='/service' className='max-lg:my-1 max-lg:mx-2 no-underline text-base font-medium leading-[24px] tracking-[1.6px] text-[#fff]'>Service</Link>
                            </li>
                            <li className="max-lg:w-[100%] max-lg:text-center max-lg:border-b max-lg:border-gray-300 max-lg:pb-2">
                                <Link to='/gallery' className='max-lg:my-1 max-lg:mx-2 no-underline text-base font-medium leading-[24px] tracking-[1.6px] text-[#fff]'>Gallery</Link>
                            </li>
                            <li className="max-lg:w-[100%] max-lg:text-center max-lg:border-b max-lg:border-gray-300 max-lg:pb-2">
                                <Link to='/blog' className='max-lg:my-1 max-lg:mx-2 no-underline text-base font-medium leading-[24px] tracking-[1.6px] text-[#fff]'>Blog</Link>
                            </li>
                ...
                <div className='max-w-[1187px] text-center mx-auto pt-[112px] pl-[24px] pr-[24px]'>
                    ...
                    <div className='flex flex-wrap justify-between max-w-[1139px] m-0 m-auto pt-[87px]
                        ...
                        <BlogBoxMain className="">
                            ...
                            <ButtonABC>Learn more</ButtonABC>
                        </BlogBoxMain>
